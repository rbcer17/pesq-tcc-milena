...
```{r}
library(readxl)
nome_int_no_missing_anova_area_queimada_parque_enso <- read_excel("/home/rbcer10/rstudio-projects/pesq-tcc-milena/dados/nome-int-no-missing-anova-area-queimada-parque-enso.xlsx")
```
